...
fn main() {
    ...
    let i1 = Freq(1);
    i1.print(&i1.gen_freq(&input));
    let i2 = Freq(2);
    i2.print(&i2.gen_freq(&input));
    let i3 = Occ("GGT");
    i3.print(&i3.gen_freq(&input));
    let i4 = Occ("GGTA");
    i4.print(&i4.gen_freq(&input));
    let i5 = Occ("GGTATT");
    i5.print(&i5.gen_freq(&input));
    let i6 = Occ("GGTATTTTAATT");
    i6.print(&i6.gen_freq(&input));
    let i7 = Occ("GGTATTTTAATTTATAGT");
    i7.print(&i7.gen_freq(&input));
